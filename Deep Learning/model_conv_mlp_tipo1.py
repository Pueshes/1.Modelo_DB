...
conv_layer = layers.Conv1D(3, 3, activation = 'relu')(permute_layer)
pool_layer = layers.AvgPool1D(pool_size = 4)(conv_layer)

conv_layer = layers.Conv1D(6, 3, activation = 'relu')(pool_layer)
pool_layer = layers.AvgPool1D(pool_size = 4)(conv_layer)
...
multi_layer = layers.Dense(15, activation = 'relu')(flatten_layer)
...
multi_layer = layers.Dense(50, activation = 'relu')(input_layer_edificos)
# MAS DE 25 PISOS

multi_layer = layers.Dense(50, activation = 'relu')(multi_layer)
# multi_layer = layers.Dense(24, activation = 'relu')(multi_layer)

multi_layer = layers.Dense(15, activation = 'relu')(multi_layer)
...
multi_layer = layers.Dense(9, activation = 'relu')(combinacion_layer)

multi_layer = layers.Dense(6, activation = 'relu')(multi_layer)
...
learningRate = 0.0001
learningDecay = 0.0001
callbackCantidad = 500
callbackTipo = 'min'
epocas = 7000
btachSize = 100

print(f'''learning rate= {learningRate}
	learning decay= {learningDecay}
