...
processing_obj.load_important('Objetos_Guardados/data_vicente')
...
ruta_guardado=f'Modelos Tensorflow/{datetime.now().strftime("%Y.%m.%d-%H.%M")}-modelo_tipo3'
...
# TODO: agregar index total del codigo processing data
index_plot_test = processing_obj.test_index[0:2]
index_plot_test= index_total[ index_plot_test]
...
index_plot_train = index_total[index_plot_train]
