...
conv_layer = layers.Conv1D(21, 3, activation = 'relu')(pool_layer)
pool_layer = layers.AvgPool1D(pool_size = 3)(conv_layer)
...
multi_layer = layers.Dense(30, activation = 'relu')(flatten_layer)
...
multi_layer = layers.Dense(30, activation = 'relu')(multi_layer)
...
multi_layer = layers.Dense(30, activation = 'relu')(combinacion_layer)
